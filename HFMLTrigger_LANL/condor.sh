...
Initialdir=/direct/sphenix+tg+tg01/hf/zshi/FastMLUConn/NewBuild/FastMLUConn/JobSub
...
#Output=/tmp
Output=/direct/sphenix+tg+tg01/hf/zshi/FastMLUConn/NewBuild/FastMLUConn/JobSub/out/job.$(Cluster).out
...
Error=/direct/sphenix+tg+tg01/hf/zshi/FastMLUConn/NewBuild/FastMLUConn/JobSub/err/job.$(Cluster).err
...
Log=/direct/sphenix+tg+tg01/hf/zshi/FastMLUConn/NewBuild/FastMLUConn/JobSub/log/myjob.$(Cluster).log
